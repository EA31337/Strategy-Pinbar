...
// Includes strategy.
#include "Stg_Pinbar.mqh"

// Defines.
#define ea_name "Strategy Pinbar"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Pinbar"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Pinbar>(Active_Tfs);
